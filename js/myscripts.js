...
function playDefencePositionOne() {
  let decider = generateRandomInteger(4);
...
function playhard() {
  let Row2 = TicTacToe[3] + TicTacToe[4] + TicTacToe[5];
  ...
  // ... (other conditions for rows, columns, and diagonals)

  else {
      return generateRandomInteger(9);
  }
}
